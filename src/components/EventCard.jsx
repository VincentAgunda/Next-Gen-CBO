  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="font-sans text-xs uppercase tracking-[0.2em] text-[#333333] border-b border-[#333333] pb-1 w-max hover:text-[#b8a898] hover:border-[#b8a898] transition-colors font-medium"
      >
        Register Now
      </Link>
    </motion.div>
