...
export default function CallAction({ setSectionRef }) {
  // Safe fallback if setSectionRef isn't passed down
  const setRef = setSectionRef || (() => () => {});

  return (
    <>
      {/* Section 5: Innovation Hub Preview */}
      <section ref={setRef(5)} className="py-28 lg:py-36 bg-[#f4f4f4] border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-col gap-12 mt-12">
            {innovations.slice(0, 3).map((inv) => (
              <div 
                key={inv.id} 
                className="bg-white grid grid-cols-1 lg:grid-cols-2 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-500 rounded-none"
              >
                {/* Left Column: Image */}
      ...
      <section ref={setRef(7)} className="py-32 lg:py-48 px-6 lg:px-24 bg-[#e5e5e5] border-b border-neutral-300/50">
      ...
      {/* Section 8: Partners */}
      <section ref={setRef(8)} className="py-24 lg:py-32 px-6 lg:px-12 bg-[#7a787d] text-white border-b border-neutral-600/30">
      ...
      <section ref={setRef(9)} className="py-32 lg:py-48 bg-[#3B3A38] text-white px-6 md:px-12 lg:px-24 relative overflow-hidden border-t border-white/15">
