...
export default function Home() {
  return (
    <div className="font-sans text-[#111111] bg-[#F5F5F7] antialiased selection:bg-[#d2b79b] selection:text-black overflow-hidden">
      <HeroSection />
      ...
      {/* FEATURED INITIATIVES: High-Contrast Dark Theme (Polestar Tech Spec Style) */}
      <section className="bg-[#2d2932] text-white py-28 lg:py-40 px-6 lg:px-24 border-b border-neutral-700">
        <div className="max-w-7xl mx-auto flex flex-col gap-28 lg:gap-40">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 relative group overflow-hidden border border-neutral-700">
              <img
                src="/Innovation/mushroom.png"
                alt="Agribusiness Development"
                className="w-full h-auto object-cover aspect-[16/10] grayscale contrast-125 group-hover:scale-105 transition-transform duration-700"
              />
          ...
          {/* Row 2 */}
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 order-1 relative group overflow-hidden border border-neutral-700">
              <img
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 gap-8 mt-12">
            {innovations.slice(0, 3).map((inv) => (
              <div key={inv.id} className="border border-neutral-300 bg-white p-2 hover:border-neutral-900 transition-colors duration-500">
                <InnovationCard {...inv} />
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-b border-white/20 pb-12 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-normal tracking-tight">
                Upcoming Events
              </h2>
            </div>
            <Link 
      ...
      {/* Section 7: Partners — Crisp & Structural Grid */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/20 border border-white/20 overflow-hidden">
            {partners.slice(0, 2).map((p, i) => (
              <div key={i} className="bg-[#6e6c71] hover:bg-[#656368] p-12 lg:p-16 flex justify-center items-center transition-colors duration-500 min-h-[220px]">
                <img 
                  src={p.image || p.logo} 
                  alt={p.name} 
                  className="max-h-24 md:max-h-32 object-contain grayscale invert opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-500 cursor-pointer" 
                />
              </div>
            ))}
          </div>
      ...
      <section className="py-32 lg:py-48 bg-[#3B3A38] text-white px-6 md:px-12 lg:px-24 relative overflow-hidden border-t border-white/15">
        <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link
              to="/membership"
              className="w-full sm:w-auto border border-white/30 bg-transparent text-white px-10 py-5 text-xs uppercase tracking-[0.25em] font-medium hover:border-white transition-all duration-500"
            >
              Become A Member
            </Link>
          </div>
